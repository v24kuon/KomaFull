...
<div class="row mb-3">
    ...
    <div class="col-md-4">
        ...
        @error('birth_date') <div class="invalid-feedback" role="alert">{{ $message }}</div> @enderror
    </div>
    <div class="col-md-4">
...
<div class="row mb-3">
    <div class="col-md-6">
        ...
        @error('licence_skill') <div class="invalid-feedback" role="alert">{{ $message }}</div> @enderror
    </div>
    <div class="col-md-6">
        ...
        @error('main_expertise') <div class="invalid-feedback" role="alert">{{ $message }}</div> @enderror
    </div>
</div>
