                ...
                <form method="POST" action="{{ route('admin.store-settings.update') }}">
                    ...
                    <div class="row mb-3">
                        <div class="col-md-6">
                            ...
                            @error('program_label') <div class="invalid-feedback" role="alert">{{ $message }}</div> @enderror
                        </div>
                        <div class="col-md-6">
                            ...
                            @error('session_label') <div class="invalid-feedback" role="alert">{{ $message }}</div> @enderror
                        </div>
                    </div>
                    ...
                    <div class="row mb-3">
                        <div class="col-md-6">
                            ...
                            @error('staff_label') <div class="invalid-feedback" role="alert">{{ $message }}</div> @enderror
                        </div>
                        <div class="col-md-6">
                            ...
                            @error('location_label') <div class="invalid-feedback" role="alert">{{ $message }}</div> @enderror
                        </div>
                    </div>
                    ...
                    <div class="row mb-3">
                        <div class="col-md-4">
                            ...
                            @error('reserve_deadline_minutes') <div class="invalid-feedback" role="alert">{{ $message }}</div> @enderror
                        </div>
                        <div class="col-md-4">
                            ...
                            @error('cancel_deadline_minutes') <div class="invalid-feedback" role="alert">{{ $message }}</div> @enderror
                        </div>
                        <div class="col-md-4">
                            ...
                            @error('withdrawal_deadline_days') <div class="invalid-feedback" role="alert">{{ $message }}</div> @enderror
                        </div>
                    </div>
